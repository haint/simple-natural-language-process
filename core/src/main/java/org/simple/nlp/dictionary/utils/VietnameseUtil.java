...
public class VietnameseUtil {
  ...
  public static final String removeVietnameseAccent(String src){
  ...
  public static final boolean containVietnameseCharacter(String src){
  ...
  public static final boolean isVietnameseCharacter(char c) {
    return removeVietnameseAccent(c) != c ;
  }

  public static final char removeVietnameseAccent(char c){
    if(c <= 'z') return c ;
    switch (c) {
      case 'À': return 'A';
      case 'à': return 'a';
